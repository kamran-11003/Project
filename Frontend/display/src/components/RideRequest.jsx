      ...
      {rideData ? (
        <Section>
          ...
          <Paragraph>
            <InfoItem>
              <MapPin size={18} />
              <InfoText><strong>Pickup:</strong> {rideData.pickup}</InfoText>
            </InfoItem>
            <InfoItem>
              <Navigation size={18} />
              <InfoText><strong>Dropoff:</strong> {rideData.dropOff}</InfoText>
            </InfoItem>
            <InfoItem>
              <AlertCircle size={18} />
              <InfoText><strong>Distance:</strong> {rideData.distance} meters</InfoText>
            </InfoItem>
            <InfoItem>
              <DollarSign size={18} />
              <InfoText><strong>Fare:</strong> ${rideData.fare}</InfoText>
            </InfoItem>
          </Paragraph>
          <ButtonGroup>
            <Button 
        ...
        rideRequest ? (
          <Section>
            ...
            <Paragraph>
              <InfoItem>
                <MapPin size={18} />
                <InfoText><strong>Pickup:</strong> {rideRequest.pickup}</InfoText>
              </InfoItem>
              <InfoItem>
                <Navigation size={18} />
                <InfoText><strong>Dropoff:</strong> {rideRequest.dropOff}</InfoText>
              </InfoItem>
              <InfoItem>
                <AlertCircle size={18} />
                <InfoText><strong>Distance:</strong> {rideRequest.distance} meters</InfoText>
              </InfoItem>
              <InfoItem>
                <DollarSign size={18} />
                <InfoText><strong>Fare:</strong> ${rideRequest.fare}</InfoText>
              </InfoItem>
            </Paragraph>
            <ButtonGroup>
              <Button 
